...
##
## This packet is received when a player finishes the race.
...
const PACKET_TYPE := InSim.Packet.ISP_FIN  ## The packet's type, see [enum InSim.Packet].
...
var gis_race_time := 0.0  ## Total race time in seconds
