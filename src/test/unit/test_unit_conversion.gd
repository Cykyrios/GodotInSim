...
var acceleration_params := [
	[10.0, GISUtils.AccelerationUnit.METER_PER_SECOND_SQUARED, GISUtils.AccelerationUnit.G, 1.019_367_992],
...
func test_acceleration_conversion(params: Array = use_parameters(acceleration_params)) -> void:
	assert_almost_eq(GISUtils.convert_acceleration(params[0], params[1], params[2]), params[3], epsilon)
...
func test_angle_conversion(params: Array = use_parameters(angle_params)) -> void:
	assert_almost_eq(GISUtils.convert_angle(params[0], params[1], params[2]), params[3], epsilon)
...
func test_force_conversion(params: Array = use_parameters(force_params)) -> void:
	assert_almost_eq(GISUtils.convert_force(params[0], params[1], params[2]), params[3], epsilon)
...
func test_length_conversion(params: Array = use_parameters(length_params)) -> void:
	assert_almost_eq(GISUtils.convert_length(params[0], params[1], params[2]), params[3], epsilon)
...
func test_mass_conversion(params: Array = use_parameters(mass_params)) -> void:
	assert_almost_eq(GISUtils.convert_mass(params[0], params[1], params[2]), params[3], epsilon)
...
func test_power_conversion(params: Array = use_parameters(power_params)) -> void:
	assert_almost_eq(GISUtils.convert_power(params[0], params[1], params[2]), params[3], epsilon)
...
func test_speed_conversion(params: Array = use_parameters(speed_params)) -> void:
	assert_almost_eq(GISUtils.convert_speed(params[0], params[1], params[2]), params[3], epsilon)
...
func test_time_conversion(params: Array = use_parameters(time_params)) -> void:
	assert_almost_eq(GISUtils.convert_time(params[0], params[1], params[2]), params[3], epsilon)
