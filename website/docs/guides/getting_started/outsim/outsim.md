...
Using OutSim requires a bit more setup than InSim, similarly to OutGauge.
...
Just like [OutGauge](./outgauge), you can create an OutSim instance entirely from code, or add it
...
includes all data in the [OutSimPack](../../../class_ref/OutSimPack) object, which is included in the
[OutSimPacket](../../../class_ref/OutSimPacket). Missing data will therefore be at thei default values;
...
We are going to use the [CarInfo](../../../class_ref/CarInfo) class to load a `CAR_info.bin` file
generated by pressing <kbd>O</kbd> in the garage view, to retrieve the drive type. We will then
use that to check only the driven wheels in the [OutSimPacket](../../../class_ref/OutSimPacket).
...
OutSim packets always include 4 [OutSimWheel](../../../class_ref/OutSimWheel) objects, the order is
given in the [OutSimPack.WheelIndex](../../../class_ref/OutSimPack#class_OutSimPack_enum_WheelIndex)
...
[OutSimWheel.ang_vel](../../../class_ref/OutSimWheel#class_OutSimWheel_property_ang_vel) is given in
...
wheel's speed to the car speed, which is part of the [OutSimMain](../../../class_ref/OutSimMain)
...
[InSimMCIPackets](../../../class_ref/InSimMCIPacket), albeit with less precision, but this allows
